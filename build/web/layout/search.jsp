...
<s:layout-definition>
    ...
    <html>
        ...
        <link href="http://bioinformatics.ua.pt/WAVe/browse/${actionBean.id}/atom" rel="alternate" type="application/atom+xml" title="${actionBean.gene.HGNC} | WAVe" />
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            oTable = $('#genes').dataTable( {
                "bPaginate" : true,
                "aoColumns": [ {"sTitle": "Result"},{"sTitle": "HGNC ID"},{"sTitle": "HGNC Symbol"}, {"sTitle": "# LSDBs"}, {"sTitle": "# Variants"} ],
                "bFilter": true,
                "bSort": true,
                "aaSorting": [[ 0, "asc" ]],
